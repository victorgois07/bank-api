...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "src/impl/infra/db/prisma/generated/client",
    "impl/infra/db/prisma/generated/client",
  ]
...
path.join(process.cwd(), "src/impl/infra/db/prisma/generated/client/libquery_engine-darwin-arm64.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/impl/infra/db/prisma/generated/client/schema.prisma")
